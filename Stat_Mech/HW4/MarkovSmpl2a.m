...
s_attempt_list = [s_attempt_list,succesful_attempt/n_steps];
end

plot(0.05:0.02:0.3,s_attempt_list)
ylabel('Succesful attempts/Total attempts' ,'FontSize', 24)
